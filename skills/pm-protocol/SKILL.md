---
name: pm-protocol
description: "Use when the user needs the pm-protocol project role or workflow formerly defined for Claude Code."
metadata:
  source: ".claude/agents/pm-protocol.md"
  migrated_from: "claude-agent-definition"
---

<!-- Migrated from .claude/agents/pm-protocol.md. Claude-specific frontmatter
