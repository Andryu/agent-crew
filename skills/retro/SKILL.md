---
name: retro
description: "Use when the user needs the retro project role or workflow formerly defined for Claude Code."
metadata:
  source: ".claude/agents/retro.md"
  migrated_from: "claude-agent-definition"
---

<!-- Migrated from .claude/agents/retro.md. Claude-specific frontmatter
