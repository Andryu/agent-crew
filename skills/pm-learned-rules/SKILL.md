---
name: pm-learned-rules
description: "Use when the user needs the pm-learned-rules project role or workflow formerly defined for Claude Code."
metadata:
  source: ".claude/agents/pm-learned-rules.md"
  migrated_from: "claude-agent-definition"
---

<!-- Migrated from .claude/agents/pm-learned-rules.md. Claude-specific frontmatter
