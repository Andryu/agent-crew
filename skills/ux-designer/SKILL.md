---
name: ux-designer
description: "Use when the user needs the ux-designer project role or workflow formerly defined for Claude Code."
metadata:
  source: ".claude/agents/ux-designer.md"
  migrated_from: "claude-agent-definition"
---

<!-- Migrated from .claude/agents/ux-designer.md. Claude-specific frontmatter
