---
name: pm
description: "Use when the user needs the pm project role or workflow formerly defined for Claude Code."
metadata:
  source: ".claude/agents/pm.md"
  migrated_from: "claude-agent-definition"
---

<!-- Migrated from .claude/agents/pm.md. Claude-specific frontmatter
