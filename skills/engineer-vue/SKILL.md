---
name: engineer-vue
description: "Use when the user needs the engineer-vue project role or workflow formerly defined for Claude Code."
metadata:
  source: ".claude/agents/engineer-vue.md"
  migrated_from: "claude-agent-definition"
---

<!-- Migrated from .claude/agents/engineer-vue.md. Claude-specific frontmatter
