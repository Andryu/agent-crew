---
name: security
description: "Use when the user needs the security project role or workflow formerly defined for Claude Code."
metadata:
  source: ".claude/agents/security.md"
  migrated_from: "claude-agent-definition"
---

<!-- Migrated from .claude/agents/security.md. Claude-specific frontmatter
