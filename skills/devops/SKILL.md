---
name: devops
description: "Use when the user needs the devops project role or workflow formerly defined for Claude Code."
metadata:
  source: ".claude/agents/devops.md"
  migrated_from: "claude-agent-definition"
---

<!-- Migrated from .claude/agents/devops.md. Claude-specific frontmatter
