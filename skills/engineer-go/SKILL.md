---
name: engineer-go
description: "Use when the user needs the engineer-go project role or workflow formerly defined for Claude Code."
metadata:
  source: ".claude/agents/engineer-go.md"
  migrated_from: "claude-agent-definition"
---

<!-- Migrated from .claude/agents/engineer-go.md. Claude-specific frontmatter
