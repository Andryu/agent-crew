---
name: qa
description: "Use when the user needs the qa project role or workflow formerly defined for Claude Code."
metadata:
  source: ".claude/agents/qa.md"
  migrated_from: "claude-agent-definition"
---

<!-- Migrated from .claude/agents/qa.md. Claude-specific frontmatter
