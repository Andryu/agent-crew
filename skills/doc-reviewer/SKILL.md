---
name: doc-reviewer
description: "Use when the user needs the doc-reviewer project role or workflow formerly defined for Claude Code."
metadata:
  source: ".claude/agents/doc-reviewer.md"
  migrated_from: "claude-agent-definition"
---

<!-- Migrated from .claude/agents/doc-reviewer.md. Claude-specific frontmatter
